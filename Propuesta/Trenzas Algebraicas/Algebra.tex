...
\end{theorem}
\begin{proof}
     Por los Lemas 3.3 y 3.4 existe un único homomorfismo de grupos $f:B_n\to S_n$, donde $f(\sigma_i)=s_i$, luego como las traspociciones simples generan $S_n$ este homomorfismo es sobreyectivo. Como $S_n$ para $n\geq 3$ es no abeliano se sigue que $B_n$ no los es.
\end{proof}
